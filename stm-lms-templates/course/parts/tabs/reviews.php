...
<?php if (!empty($reviews)):
    ...
    <div class="clearfix stm_lms_average__rating">
            ...
            <div class="average_rating_unit heading_font">
                ...
                <div class="average-rating-stars">
                    <div class="star-rating"
                         title="<?php printf(esc_html__('5 dan %s baho', 'masterstudy-lms-learning-management-system'), $average); ?>">
						<span style="width:<?php echo esc_attr($percent); ?>%">
							<strong class="rating"><?php echo esc_attr($average); ?></strong>
							<?php esc_html_e('5 dan', 'masterstudy-lms-learning-management-system'); ?>
						</span>
                    </div>
                </div>
                <div class="average_rating_num"><?php printf(esc_html__('%s Baholar', 'masterstudy-lms-learning-management-system'), count($reviews)); ?></div>
            </div>
        </div>
        ...
        <div class="detailed_rating">
            <h4 class="rating_sub_title"><?php esc_html_e('Batafsil baholash', 'masterstudy-lms-learning-management-system'); ?></h4>
            <table class="detail_rating_unit normal_font">
                <tbody>
				<?php foreach ($marks as $mark => $mark_count): ?>
                    <tr class="stars_5">
                        <td class="key"><?php printf(esc_html__('Baho %s', 'masterstudy-lms-learning-management-system'), $mark) ?></td>
                        <td class="bar">
                            <div class="full_bar">
    ...
    <div id="stm-lms-reviews" v-bind:class="{'loading' : loading}">
        <div class="stm-lms-reviews">
            ...
            <a @click="getReviews()" v-if="!total" class="btn btn-default" v-bind:class="{'loading' : loading}">
                <span><?php esc_html_e('Ko\'proq ko\'rsatish', 'masterstudy-lms-learning-management-system'); ?></span>
            </a>
        </div>
    </div>
<?php else: ?>
    <h4><?php esc_html_e('Birinchi bo\'lib izoh qoldiring.', 'masterstudy-lms-learning-management-system'); ?></h4>
<?php endif; ?>
